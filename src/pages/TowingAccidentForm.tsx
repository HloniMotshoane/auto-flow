...
export default function TowingAccidentForm() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold tracking-tight">New Accident Tow</h1>
            <p className="text-sm text-muted-foreground">Create a new accident towing record</p>
          </div>
        </div>
      </div>
